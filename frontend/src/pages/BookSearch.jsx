    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      ...
      <div className="flex-1 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="bg-slate-900/80 border border-slate-800/80 backdrop-blur-xl rounded-2xl p-4 sm:p-6 shadow-2xl shadow-indigo-950/20 space-y-4">
          ...
          {!loading && books.length === 0 && !error && (
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-12 text-center max-w-lg mx-auto space-y-4">
              ...
              <button
                type="button"
                onClick={handleClear}
                className="mt-4 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold rounded-lg transition cursor-pointer"
              >
