  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 pb-2 border-b border-slate-900">
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Browse notes shared across all 4 academic years or contribute your own study guides.
            </p>
          </div>
            ...
            <div className="flex items-center gap-1.5 flex-wrap bg-slate-900/80 p-1 rounded-xl border border-slate-800">
              {YEARS.map((y) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition cursor-pointer ${selectedYearFilter === y.value
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1 bg-slate-950 p-1 rounded-xl border border-slate-700">
                    <button
                      ...
                      className={`flex items-center justify-center gap-1 py-1 rounded-lg text-xs font-semibold transition cursor-pointer ${uploadMode === 'link'
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-1 py-1 rounded-lg text-xs font-semibold transition cursor-pointer ${uploadMode === 'file'
                        ? 'bg-purple-600 text-white shadow'
                        : 'text-slate-400 hover:text-slate-200'
                        }`}
                    >
